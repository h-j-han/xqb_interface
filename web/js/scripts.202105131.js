...
pause_button.onclick = function(event) {
    ...
    if (task_completed) {
        ...
        pause_modal_content.innerHTML = 'New Start. <br> If you want to try out this interface, please enter "test". <br> Currently available rounds : 1 . <br> Please start round 1.';
    }
